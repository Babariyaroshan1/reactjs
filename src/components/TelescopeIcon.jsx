...
const TelescopeIcon = ({ width = 72, height = 72 }) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 72 72"
  ...
  >
    ...
    <defs>
      <radialGradient id="paint0_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(36.6875 32.7016) rotate(135) scale(34.9134)">
        <stop stopColor="#99421D" />
        <stop offset="0.333" stopColor="#99161D" />
        <stop offset="0.666" stopColor="#7D1845" />
        <stop offset="1" stopColor="#59216E" />
      </radialGradient>
      <radialGradient id="paint1_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(42.5937 27.2992) rotate(135) scale(44.5477 44.5279)">
        <stop stopColor="#EF7744" />
        <stop offset="0.333" stopColor="#E50914" />
        <stop offset="0.666" stopColor="#A70D53" />
        <stop offset="1" stopColor="#792A95" />
      </radialGradient>
      <radialGradient id="paint2_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(42.3 29.106) rotate(135) scale(31.8127)">
        <stop stopColor="#FB540D" />
        <stop offset="0.333" stopColor="#E50914" />
        <stop offset="0.666" stopColor="#A70D53" />
        <stop offset="1" stopColor="#792A95" />
      </radialGradient>
      <radialGradient id="paint3_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(57.675 14.7078) rotate(134.326) scale(24.0433 24.0367)">
        <stop stopColor="#FFDCCC" />
        <stop offset="0.333" stopColor="#FFBDC0" />
        <stop offset="0.666" stopColor="#F89DC6" />
        <stop offset="1" stopColor="#E4A1FA" />
      </radialGradient>
      <radialGradient id="paint4_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(52.1305 21.273) rotate(141.875) scale(9.87138 12.8159)">
        <stop offset="0.307" stopColor="#F89DC6" />
        <stop offset="0.645" stopColor="#E75094" />
        <stop offset="1" stopColor="#59216E" />
      </radialGradient>
      <radialGradient id="paint5_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(55.8 15.6) rotate(135) scale(13.1522)">
        <stop stopColor="white" />
        <stop offset="1" stopColor="white" stopOpacity="0" />
      </radialGradient>
      <radialGradient id="paint6_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(49.2362 22.9648) rotate(131.079) scale(5.08644 6.006)">
        <stop stopColor="white" />
        <stop offset="1" stopColor="white" stopOpacity="0" />
      </radialGradient>
      <radialGradient id="paint7_radial" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(36.8758 29.1353) rotate(137.622) scale(13.5764)">
        <stop stopColor="#FFA984" />
        <stop offset="1" stopColor="#F7636B" stopOpacity="0" />
      </radialGradient>
      <linearGradient id="paint8_linear" x1="44.65" y1="27.9016" x2="24.25" y2="48.3016" gradientUnits="userSpaceOnUse">
        <stop stopColor="#EF7744" />
        <stop offset="0.333" stopColor="#E50914" />
        <stop offset="0.666" stopColor="#A70D53" />
        <stop offset="1" stopColor="#792A95" />
